...
import { ArrowLeft, Plus, Search, Filter, Eye, X, Calendar, DollarSign, FileText, User, MapPin, Package, Clock, AlertCircle, Save } from 'lucide-react';
                                ...
                                <tbody className="divide-y divide-border/50">
                                    {filteredOrders.length === 0 ? (
                                        ...
                                        >
                                            ...
                                            <td className="p-4">
                                                <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest ${order.status === 'Cancelled' ? 'bg-red-500/10 text-red-600 border border-red-500/20' :
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                            <div className="flex items-center gap-4">
                                <button
                                    ...
                                    className="p-2 hover:bg-secondary border border-border rounded-xl bg-card text-foreground transition-colors flex items-center justify-center shadow-sm"
                                    title="Back to Orders and Agents"
                                >
                                    <ArrowLeft className="w-5 h-5" />
                                </button>
                                <div>
                                    <h2 className="text-3xl font-bold tracking-tight text-foreground flex items-center gap-3">
                                        Edit Order: {editOrder.soNo}
                                        <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-[12px] font-bold uppercase tracking-widest ${editOrder.status === 'Cancelled' ? 'bg-red-500/10 text-red-600 border border-red-500/20' :
                                            editOrder.status === 'Delivered' ? 'bg-green-500/10 text-green-600 border border-green-500/20' :
                                                'bg-primary/10 text-primary border border-primary/20'
                                            }`}>
                                            {editOrder.status}
                                        </span>
                            ...
                            <div className="flex items-center gap-3">
                                <button
                                    ...
                                    className="flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground text-sm font-bold rounded-xl shadow-lg hover:shadow-primary/20 transition-all hover:scale-105 active:scale-95"
                                >
